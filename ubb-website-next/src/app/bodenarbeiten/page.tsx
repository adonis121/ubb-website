...
export default function BodenarbeitenPage() {
    ...
    <>
      <section className="hero hero-slim" style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="wrap" style={{ position: 'relative', zIndex: 2 }}>
          <div className="breadcrumb">
            <Link href="/">Home</Link><span className="sep">/</span>Bodenarbeiten
          </div>
        ...
        <div className="wrap">
          ...
          <div className="service-feat-list">
            {cat.subServices.map((s) => (
              <Link key={s.slug} className="service-feat-row" href={`/bodenarbeiten/${s.slug}`}>
      ...
      <section className="cta-band">
        <div className="wrap inner">
          <h2>Welcher Boden passt zu <em>Ihrem</em> Projekt?</h2>
          <div className="actions">
            <Link className="btn btn-white" href="/anfrage">Beratung anfragen <span className="arrow">→</span></Link>
