...
const cat = enServices.find((s) => s.slug === 'sanierung-umbau')!
...
export default function EnRenovationPage() {
    ...
    <>
      <section className="hero hero-slim" style={{ position: 'relative', overflow: 'hidden' }}>
        {serviceImages['sanierung-umbau'] && (
          <>
            <div style={{ position: 'absolute', inset: 0, zIndex: 0 }}>
              <Image src={serviceImages['sanierung-umbau']} alt={cat.title} fill style={{ objectFit: 'cover', objectPosition: 'center' }} priority />
            </div>
        ...
        <div className="wrap" style={{ position: 'relative', zIndex: 2 }}>
          <div className="breadcrumb"><Link href="/en">Home</Link><span className="sep">/</span>Renovation &amp; Conversion</div>
      ...
      <section className="section">
        <div className="wrap">
          <div className="section-head"><span className="kicker">Services</span><h2>Four trades, one contact.</h2></div>
          <div className="service-feat-list">
            {cat.subServices.map((s) => (
              <Link key={s.slug} className="service-feat-row" href={`/en/renovation/${s.slug}`}>
      ...
      <section className="section alt">
        <div className="wrap">
          <div className="section-head"><span className="kicker">Process</span><h2>How your renovation works.</h2></div>
      ...
      {relProjects.length > 0 && (
        <section className="section">
          <div className="wrap">
            <div className="section-head"><span className="kicker">References</span><h2>Renovation projects from the region.</h2></div>
      ...
      <section className="cta-band">
        <div className="wrap inner">
          <h2>What's hiding in <em>your</em> building?</h2>
          <div className="actions">
            <Link className="btn btn-white" href="/en/contact">Request a site survey <span className="arrow">→</span></Link>
