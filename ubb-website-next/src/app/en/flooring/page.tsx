  ...
  return (
    <>
      ...
      <section className="section">
        <div className="wrap">
          <div className="section-head"><span className="kicker">Services</span><h2>Six trades, one standard.</h2></div>
      ...
      <section className="section alt">
        <div className="wrap">
          <div className="section-head"><span className="kicker">Process</span><h2>How your floor project works.</h2></div>
